                ...
                <div className='grid sm:grid-cols-[minmax(100px,636px)_minmax(100px,491px)] grid-cols-1 gap-16'>
                    ...
                    <form action="submit" className='p-6 rounded-3xl border bg-[rgba(255,255,255,0.05)] border-[#373737]'>
                        <div className='flex flex-col gap-7'>
                            ...
                            <Button
                                className="w-full h-12 text-[#FFF]  bg-[linear-gradient(90deg,#F3FE00_0%,#33DE1D_100%)]"
                            >
                            ...
                            <div className='flex flex-col  gap-3'>
                                ...
                                <div className='flex flex-col sm:flex-row sm:items-center items-start gap-4'>
                                    <Link href="https://wa.me/+14232493851" target='blank' aria-label='contact us on whatsapp via +14232493851' className='text-sm leading-5 text-[#BDBDBD] flex items-center gap-1.5'>
                                        <Whatsapp />
                                        +14232493851</Link>
                                    <Link href="mailto:businessmanager@zeeframes.com" target='blank' aria-label='Mail us on businessmanager@zeeframes.com' className='text-sm leading-5 text-[#BDBDBD] flex items-center gap-1.5'>
                                        <Mail />
