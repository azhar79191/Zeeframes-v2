  ...
  return (
      <section className='py-20 bg-[#0D0D0D] relative z-50'>
        <div className='container'>
            <div className='grid grid-cols-3 gap-18 mx-60'>
            {cardsData.map((item,index)=>(
              ...
              <div className='p-8 mt-18 rounded-xl bg-[#F3FE00] mx-26'>
                <div className='flex items-center justify-center gap-18'>
                <div className='flex items-center gap-5'>
                  <h3 className="text-[#0B0B0B] text-[40px] font-extrabold font-['Inter']">224</h3>
                  <p className="text-[#0B0B0B] text-sm w-22 leading-6 font-['Inter']">Reviews on 3 platforms</p>
                  </div>
