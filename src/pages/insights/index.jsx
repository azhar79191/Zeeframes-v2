          ...
          <section className='py-20 bg-[#0D0D0D]'>
              <div className='container'>
                  <div className='flex relative items-center flex-col gap-3 justify-between'>
                      <h1 className=" text-white text-7xl max-w-230 text-center font-extrabold leading-24 items-center font-['Geologica'] uppercase">Stay Updated With Our insights</h1>
                      <p className="text-white text-lg leading-[27px] max-w-135 text-center font-['Inter']">Read our thoughts and insights on UI UX design</p>
                  ...
                  <div className="mt-8 flex justify-center items-center mx-auto">
                      ...
                      <button className='px-0.5 w-9 h-9 flex items-center justify-center absolute right-126 rounded-full shrink-0 bg-[rgba(255,255,255,0.10)]'><InsightSearch/></button>
                  </div>
              </div>
