...
const ServiceCard = ({ tag, title, image,link }) => {
  return (
    <div className="group  relative w-[579px] overflow-hidden border-y border-white/10 bg-gradient-to-b from-black to-[#0a0a0a] transition-all duration-700 hover:border-l-2 hover:border-white/10 hover:px-8">
      ...
      <div className="transition-transform py-10 duration-700 group-hover:translate-x-3">
        ...
        <h3 className="pt-5 text-[28px] font-medium ff_geologica text-white">
          {title}
        </h3>
      </div>

      {/* Arrow (moves LEFT on hover) */}
      <div className="absolute right-3 top-15 transition-transform duration-700 group-hover:-translate-x-8">
